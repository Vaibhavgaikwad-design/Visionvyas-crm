                ...
                <div class="content-sidebar content-sidebar-md" data-scrollbar-target="#psScrollbarInit">
                    ...
                    <div class="content-sidebar-body">
                        <ul class="nav flex-column nxl-content-sidebar-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="settings-leads.html">
                    ...
                    <div class="content-area-body">
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <div class="mb-0">
                                    <label class="form-label">Do not allow leads to be edited after they are converted to customers (administrators not applied)</label>
                                    <select class="form-select" data-select2-selector="icon">
                                        <option value="" data-icon="feather-check text-success" selected>Yes</option>
                                        <option value="" data-icon="feather-x text-danger">No</option>
                                    </select>
                                    <small class="form-text text-muted">Do not allow leads to be edited after they are converted to customers (administrators not applied) [Ex: Yes/No]</small>
                                </div>
                            </div>
                        </div>
                    </div>
