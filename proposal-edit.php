                        ...
                        <div class="card stretch stretch-full">
                            <div class="card-body">
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" placeholder="Subject" value="Website design and development proposal">
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Related <span class="text-danger">*</span></label>
                                    <select class="form-control" data-select2-selector="icon">
                                        <option value="lead" data-icon="feather-at-sign" selected>Lead</option>
                                ...
                                <div class="mb-4">
                                    ...
                                    <select class="form-select form-control" data-select2-selector="visibility">
                                        ...
                                        <option value="private" data-icon="feather-lock" selected>Private</option>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 mb-4">
                                        ...
                                        <input class="form-control" id="startDate" value="26/03/2023" placeholder="Pick start date ">
                                    </div>
                                    <div class="col-lg-6 mb-4">
                                        <label class="form-label">Due <span class="text-danger">*</span></label>
                                        <input class="form-control" id="dueDate" value="30/03/2023" placeholder="Pick due date">
                                    </div>
                                </div>
                                <div class="mb-4">
                                ...
                                <div class="mb-0">
                                    ...
                                    <select class="form-select form-control" data-select2-selector="user" multiple>
                                        ...
                                        <option value="mar.audrey@gmail.com" data-user="11" selected>mar.audrey@gmail.com</option>
                        ...
                        <div class="card stretch stretch-full">
                            <div class="card-body">
                                ...
                                <div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 mb-4">
                                            <input type="text" class="form-control mb-2" placeholder="Address Line 1" value="P.O. Box 18728">
                                        </div>
                                        <div class="col-lg-6 mb-4">
                                            <input type="text" class="form-control" placeholder="Address Line 2" value="DeLorean New York">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6 mb-4">
                                        ...
                                        <input type="text" class="form-control" placeholder="Emial" value="green.cutte@outlook.com">
                                    </div>
                                    <div class="col-lg-6 mb-4">
                                        <label class="form-label">Phone <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" placeholder="Phone" value="+1 (375) 9632 458">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6 mb-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 mb-4">
                                        ...
                                        <select class="form-control" data-select2-selector="tzone">
                                            ...
                                            <option data-tzone="feather-sunrise" selected>(GMT) Western Europe Time</option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 mb-4">
                                        ...
                                        <select class="form-control" data-select2-selector="status">
                                            ...
                                            <option value="primary" data-bg="bg-primary" selected>Open</option>
                                ...
                                <div class="row mb-4">
                                    <div class="form-check form-switch form-switch-sm ps-5">
                                        <input class="form-check-input c-pointer" type="checkbox" id="commentSwitch" checked>
                                            ...
                                            <table class="table table-bordered overflow-hidden" id="tab_logic">
                                                ...
                                                <tbody>
                                                    <tr id="addr0">
                                                        ...
                                                        <td><input type="number" name="qty[]" placeholder="Qty" class="form-control qty" step="1" min="1" value="1"></td>
                                                        <td><input type="number" name="price[]" placeholder="Unit Price" class="form-control price" step="1.00" min="1" value="250.00"></td>
                                                        <td><input type="number" name="total[]" placeholder="0.00" class="form-control total" readonly="" value="250.00"></td>
                                                    </tr>
                                                    <tr id="addr1">
                                                        <td>2</td>
                                                        <td><input type="text" name="product[]" placeholder="Product Name" class="form-control" value="Search engine optimization (SEO) optimization"></td>
                                                        <td><input type="number" name="qty[]" placeholder="Qty" class="form-control qty" step="1" min="1" value="2"></td>
                                                        <td><input type="number" name="price[]" placeholder="Unit Price" class="form-control price" step="1.00" min="1" value="300.00"></td>
                                                        <td><input type="number" name="total[]" placeholder="0.00" class="form-control total" readonly="" value="600.00"></td>
                                                    </tr>
                                                    <tr id="addr2">
                                                        <td>3</td>
                                                        <td></td>
                                            ...
                                            <table class="table table-bordered" id="tab_logic_total">
                                                <tbody>
                                                    <tr class="single-item">
                                                        ...
                                                        <td class="w-25"><input type="number" name="sub_total" placeholder="0.00" class="form-control border-0 bg-transparent p-0" id="sub_total" readonly="" value="850.00"></td>
                                                    </tr>
                                                    <tr class="single-item">
                                                        <th class="fs-10 text-dark text-uppercase">Tax</th>
                                                        <td class="w-25">
                                                            <div class="input-group mb-2 mb-sm-0">
                                                                <input type="number" class="form-control border-0 bg-transparent p-0" id="tax" placeholder="0" value="10">
                                                    ...
                                                    <tr class="single-item">
                                                        ...
                                                        <td class="w-25"><input type="number" name="tax_amount" id="tax_amount" placeholder="0.00" class="form-control border-0 bg-transparent p-0" readonly="" value="85.00"></td>
                                                    </tr>
                                                    <tr class="single-item">
                                                        <th class="fs-10 text-dark text-uppercase bg-gray-100">Grand Total</th>
                                                        <td class="bg-gray-100 w-25"><input type="number" name="total_amount" id="total_amount" placeholder="0.00" class="form-control border-0 bg-transparent p-0 fw-700 text-dark" readonly="" value="935.00"></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
