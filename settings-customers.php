                ...
                <div class="content-sidebar content-sidebar-md" data-scrollbar-target="#psScrollbarInit">
                    ...
                    <div class="content-sidebar-body">
                        <ul class="nav flex-column nxl-content-sidebar-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="settings-customers.html">
                    ...
                    <div class="content-area-body">
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <div class="mb-5">
                                    <label class="form-label">Allow customers to register </label>
                                    <select class="form-select" data-select2-selector="icon">
                                        <option value="" data-icon="feather-check text-success" selected>Yes</option>
                                        <option value="" data-icon="feather-x text-danger">No</option>
                                    </select>
                                    <small class="form-text text-muted">Allow customers to register [Ex: Yes/No]</small>
                                </div>
                                <div class="mb-5">
                                ...
                                <div class="mb-5">
                                    <label class="form-label">Allow contacts to delete own files uploaded from customers area </label>
                                    <select class="form-select" data-select2-selector="icon">
                                        <option value="" data-icon="feather-check text-success">Yes</option>
                                        <option value="" data-icon="feather-x text-danger" selected>No</option>
                                    </select>
                                    <small class="form-text text-muted">Allow contacts to delete own files uploaded from customers area [Ex: Yes/No]</small>
                                </div>
                                <div class="mb-5">
